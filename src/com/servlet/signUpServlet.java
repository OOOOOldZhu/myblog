	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(signup.checkNickname(user)) {
			if(signup.insertUser(user)) {
				out.println("<a href=\"login.jsp\">signup sucseess!</a>");
			}
			else {
				out.println("<a href=\"signup.jsp\">signup fail,zhu ce fail</a>");
			}
		}
		else {
			out.println("<a href=\"signup.jsp\"> this user have inited</a>");
		}
	}
